...
//
//        generateView()
//        interstitial = GADInterstitial(adUnitID: "ca-app-pub-6435289462042400/2254517700")
...
//        }
//
//        pageViewController.setViewControllers([contents[0]], direction:
...
//
//        pageControl.frame = CGRectMake(0, CGRectGetMaxY(self.view.frame) -
    //kPageControlHeight, self.view.bounds.size.width, kPageControlHeight)
...
//
//    func pageViewController(pageViewController: UIPageViewController,
    //didFinishAnimating finished: Bool, previousViewControllers: [AnyObject], transitionCompleted completed: Bool) {
//        if !completed {
//            return
//        }
//
